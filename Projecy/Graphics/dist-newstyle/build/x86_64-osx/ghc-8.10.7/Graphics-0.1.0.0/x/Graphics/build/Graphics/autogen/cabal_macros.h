...
/* package Graphics-0.1.0.0 */
#ifndef VERSION_Graphics
#define VERSION_Graphics "0.1.0.0"
#endif /* VERSION_Graphics */
#ifndef MIN_VERSION_Graphics
#define MIN_VERSION_Graphics(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Graphics */
...
#define CURRENT_COMPONENT_ID "Graphics-0.1.0.0-inplace-Graphics"
